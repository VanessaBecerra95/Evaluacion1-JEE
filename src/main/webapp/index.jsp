...
<div class="container">
    ...
    <form action="formController" method="post">
        ...
        <label for="direccion">Dirección:</label> <input type="text" id="direccion" name="direccion" required placeholder="Nombre de calle #123">
        ...
        <fieldset>
            ...
            <label> <input type="checkbox" id="Instagram" name="redesSociales" value="Instagram"/> Instagram </label>
        ...
        <button type="submit"><i class="fa-solid fa-floppy-disk"></i> Enviar</button>
    </form>
</div>
